...
export default function Layout({ title, description, children }) {
	...
	const [anchorEl, setAnchorEl] = useState(null); //TO open or close menu.
		...
		<div>
			...
			<ThemeProvider theme={theme}>
					...
					<Toolbar className={classes.toolbar}>
						<Box display='flex' alignItems='center'>
							...
							<NextLink href='/' passHref>
								<Link>
									<Typography className={classes.brand}>Shanty Shop</Typography>
								</Link>
							</NextLink>
						</Box>
						<Drawer
				...
				<footer className={classes.footer}>
					<Typography>All rights reserved. Giancarlo Guerra 2020.</Typography>
				</footer>
			</ThemeProvider>
		</div>
	);
